...
public enum DungeonState { inactive, generatingMain, generatingBaranches, cleanup, completed }
...
public class DungeonGenerator : MonoBehaviour
{
    ...
    [Range(0, 500)] [SerializeField] int branchLength = 5;
    ...
    IEnumerator DungeonBuild()
    {
        ...
        // branching
        dungeonState = DungeonState.generatingBaranches;
        ...
        if(hits.Count > 0)
        {
            ...
            { // hit something (other than tileFrom or tileTo)
                ...
                if (tileFrom != null)
                {
                    ...
                    {
                        tileTo = CreateTile();
                        Color retryColor = container.name.Contains("Branch") ? Color.red : Color.yellow;
